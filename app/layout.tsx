...
export const metadata = {
  ...
  keywords: 'image behind image, image overlay, logo behind image, text behind image, logos behind image, shapes behind image, remove background, clone objects, change background, glowing text effect, image editor, photo editing, advanced image editor',
  icons: {
    icon: '/favicon.ico',
  },
};
